...
class Base_dataset(Dataset):
    def __init__(self, train=True, datapath=""):
        ...
        X = df[['L1_I', 'L1_D', 'L2', 'L3', 'hz', "Base_Pointers", 'Peak_Pointers', 'Memory', 'cores', 'Nominal', 'base']]
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        with open("/home/users/HuZhanyi/dataspace1/log_save/CINT2017_speed_base_model_%s.txt" % str(num_epochs), 'w+') as f:
            f.write('')
        with open("/home/users/HuZhanyi/dataspace1/log_save/CINT2017_speed_base_model_%s.txt" % str(num_epochs), 'a+') as f:
